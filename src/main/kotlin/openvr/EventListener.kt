...
//import kool.stak
//import lib.*
//import lib.VREventType as ET
//import lib.vr.maxTrackedDeviceCount
...
//            if (hmd.getTrackedDeviceClass(i) == TrackedDeviceClass.Controller && hmd.getControllerState(i, states[i], states[i].size()))
//                if (left == -1) left = i
//                else right = i
//        }
...
//            ET.ButtonPress -> buttonPress(event.trackedDeviceIndex == left, VREvent_Controller(event.data.pointer).button)
//            ET.ButtonUnpress -> buttonUnpress(event.trackedDeviceIndex == left, VREvent_Controller(event.data.pointer).button)
//            ET.ButtonTouch -> buttonTouch(event.trackedDeviceIndex == left, VREvent_Controller(event.data.pointer).button)
//            ET.ButtonUntouch -> buttonUntouch(event.trackedDeviceIndex == left, VREvent_Controller(event.data.pointer).button)
...
//
//        val EVRButtonId.press get() = update().let { _state.buttonPressed has this }
//        val EVRButtonId.pressDown get() = update().let { _state.buttonPressed has this && _prevState.buttonPressed hasnt this }
//        val EVRButtonId.pressUp get() = update().let { _state.buttonPressed hasnt this && _prevState.buttonPressed has this }
//
...
//
//        val EVRButtonId.touch get() = update().let { _state.buttonTouched has this }
//        val EVRButtonId.touchDown get() = update().let { _state.buttonTouched has this && _prevState.buttonTouched hasnt this }
//        val EVRButtonId.touchUp get() = update().let { _state.buttonTouched hasnt this && _prevState.buttonTouched has this }
//
//        val _axis = Vec2()

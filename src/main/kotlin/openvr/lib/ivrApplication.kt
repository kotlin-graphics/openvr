...
open class IVRApplications : Structure {
    ...
    infix fun addApplicationManifest(applicationManifestFullPath: String) = AddApplicationManifest!!.invoke(applicationManifestFullPath, false)

    fun addApplicationManifest(applicationManifestFullPath: String, temporary: Boolean) = AddApplicationManifest!!.invoke(applicationManifestFullPath, temporary)

    @JvmField
    var AddApplicationManifest: AddApplicationManifest_callback? = null
    ...
    infix fun removeApplicationManifest(applicationManifestFullPath: String) = EVRApplicationError.of(RemoveApplicationManifest!!.invoke(applicationManifestFullPath))

    @JvmField
    var RemoveApplicationManifest: RemoveApplicationManifest_callback? = null
    ...
    infix fun isApplicationInstalled(appKey: String) = IsApplicationInstalled!!.invoke(appKey)

    @JvmField
    var IsApplicationInstalled: IsApplicationInstalled_callback? = null
    ...
    val applicationCount get() = GetApplicationCount!!.invoke()

    @JvmField
    var GetApplicationCount: GetApplicationCount_callback? = null
    ...
    fun getApplicationKeyByIndex(applicationIndex: Int, appKeyBuffer: String, appKeyBufferLen: Int) = EVRApplicationError.of(GetApplicationKeyByIndex!!.invoke(applicationIndex, appKeyBuffer, appKeyBufferLen))

    @JvmField
    var GetApplicationKeyByIndex: GetApplicationKeyByIndex_callback? = null
    ...
    fun getApplicationKeyByProcessId(processId: Int, appKeyBuffer: String, appKeyBufferLen: Int) = EVRApplicationError.of(GetApplicationKeyByProcessId!!.invoke(processId, appKeyBuffer, appKeyBufferLen))

    @JvmField
    var GetApplicationKeyByProcessId: GetApplicationKeyByProcessId_callback? = null
    ...
    infix fun launchApplication(appKey: String) = EVRApplicationError.of(LaunchApplication!!.invoke(appKey))

    @JvmField
    var LaunchApplication: LaunchApplication_callback? = null
     ...
     *  launched     */
    fun launchApplicationFromMimeType(mimeType: String, args: String) = EVRApplicationError.of(LaunchApplicationFromMimeType!!.invoke(mimeType, args))

    @JvmField
    var LaunchApplicationFromMimeType: LaunchApplicationFromMimeType_callback? = null
    ...
    infix fun launchDashboardOverlay(appKey: String) = EVRApplicationError.of(LaunchDashboardOverlay!!.invoke(appKey))

    @JvmField
    var LaunchDashboardOverlay: LaunchDashboardOverlay_callback? = null
    ...
    infix fun cancelApplicationLaunch(appKey: String) = CancelApplicationLaunch!!.invoke(appKey)

    @JvmField
    var CancelApplicationLaunch: CancelApplicationLaunch_callback? = null
    ...
    fun identifyApplication(processId: Int, appKey: String) = EVRApplicationError.of(IdentifyApplication!!.invoke(processId, appKey))

    @JvmField
    var IdentifyApplication: IdentifyApplication_callback? = null
    ...
    infix fun getApplicationProcessId(appKey: String) = GetApplicationProcessId!!.invoke(appKey)

    @JvmField
    var GetApplicationProcessId: GetApplicationProcessId_callback? = null
    ...
    infix fun getApplicationsErrorNameFromEnum(error: EVRApplicationError) = GetApplicationsErrorNameFromEnum!!.invoke(error.i)

    @JvmField
    var GetApplicationsErrorNameFromEnum: GetApplicationsErrorNameFromEnum_callback? = null
    ...
    @JvmOverloads
    fun getApplicationPropertyString(appKey: String, eProperty: EVRApplicationProperty, propertyValueBuffer: String, propertyValueBufferLen: Int, error: EVRApplicationError_ByReference? = null) = GetApplicationPropertyString!!.invoke(appKey, eProperty.i, propertyValueBuffer, propertyValueBufferLen, error)

    @JvmField
    var GetApplicationPropertyString: GetApplicationPropertyString_callback? = null
    ...
    @JvmOverloads
    fun getApplicationPropertyBool(appKey: String, property: EVRApplicationProperty, error: EVRApplicationError_ByReference? = null) = GetApplicationPropertyBool!!.invoke(appKey, property.i, error)

    @JvmField
    var GetApplicationPropertyBool: GetApplicationPropertyBool_callback? = null
    ...
    @JvmOverloads
    fun getApplicationPropertyUint64(appKey: String, property: EVRApplicationProperty, error: EVRApplicationError_ByReference? = null) = GetApplicationPropertyUint64!!.invoke(appKey, property.i, error)

    @JvmField
    var GetApplicationPropertyUint64: GetApplicationPropertyUint64_callback? = null
    ...
    fun setApplicationAutoLaunch(appKey: String, autoLaunch: Boolean) = EVRApplicationError.of(SetApplicationAutoLaunch!!.invoke(appKey, autoLaunch))

    @JvmField
    var SetApplicationAutoLaunch: SetApplicationAutoLaunch_callback? = null
    ...
    infix fun getApplicationAutoLaunch(appKey: String) = GetApplicationAutoLaunch!!.invoke(appKey)

    @JvmField
    var GetApplicationAutoLaunch: GetApplicationAutoLaunch_callback? = null
    ...
    fun setDefaultApplicationForMimeType(appKey: String, mimeType: String) = EVRApplicationError.of(SetDefaultApplicationForMimeType!!.invoke(appKey, mimeType))

    @JvmField
    var SetDefaultApplicationForMimeType: SetDefaultApplicationForMimeType_callback? = null
    ...
    fun getDefaultApplicationForMimeType(mimeType: String, appKeyBuffer: String, appKeyBufferLen: Int) = GetDefaultApplicationForMimeType!!.invoke(mimeType, appKeyBuffer, appKeyBufferLen)

    @JvmField
    var GetDefaultApplicationForMimeType: GetDefaultApplicationForMimeType_callback? = null
    ...
    fun getApplicationSupportedMimeTypes(appKey: String, mimeTypesBuffer: String, mimeTypesCount: Int) = GetApplicationSupportedMimeTypes!!.invoke(appKey, mimeTypesBuffer, mimeTypesCount)

    @JvmField
    var GetApplicationSupportedMimeTypes: GetApplicationSupportedMimeTypes_callback? = null
    ...
    fun getApplicationsThatSupportMimeType(mimeType: String, appKeysThatSupportBuffer: String, appKeysCount: Int) = GetApplicationsThatSupportMimeType!!.invoke(mimeType, appKeysThatSupportBuffer, appKeysCount)

    @JvmField
    var GetApplicationsThatSupportMimeType: GetApplicationsThatSupportMimeType_callback? = null
    ...
    fun getApplicationLaunchArguments(handle: Int, args: String, argsCount: Int) = GetApplicationLaunchArguments!!.invoke(handle, args, argsCount)

    @JvmField
    var GetApplicationLaunchArguments: GetApplicationLaunchArguments_callback? = null
    ...
    fun getStartingApplication(appKeyBuffer: String, appKeyBufferLen: Int) = EVRApplicationError.of(GetStartingApplication!!.invoke(appKeyBuffer, appKeyBufferLen))

    @JvmField
    var GetStartingApplication: GetStartingApplication_callback? = null
    ...
    val transitionState get() = GetTransitionState!!.invoke().toEVRApplicationTransitionState()

    @JvmField
    var GetTransitionState: GetTransitionState_callback? = null
    ...
    infix fun performApplicationPrelaunchCheck(appKey: String) = EVRApplicationError.of(PerformApplicationPrelaunchCheck!!.invoke(appKey))

    @JvmField
    var PerformApplicationPrelaunchCheck: PerformApplicationPrelaunchCheck_callback? = null
    ...
    infix fun getApplicationsTransitionStateNameFromEnum(state: EVRApplicationTransitionState) = GetApplicationsTransitionStateNameFromEnum!!.invoke(state.i)

    @JvmField
    var GetApplicationsTransitionStateNameFromEnum: GetApplicationsTransitionStateNameFromEnum_callback? = null
    ...
    val isQuitUserPromptRequested get() = IsQuitUserPromptRequested!!.invoke()

    @JvmField
    var IsQuitUserPromptRequested: IsQuitUserPromptRequested_callback? = null
    ...
    fun launchInternalProcess(binaryPath: String, arguments: String, workingDirectory: String) = EVRApplicationError.of(LaunchInternalProcess!!.invoke(binaryPath, arguments, workingDirectory))

    @JvmField
    var LaunchInternalProcess: LaunchInternalProcess_callback? = null
    ...
    val currentSceneProcessId get() = GetCurrentSceneProcessId!!.invoke()

    @JvmField
    var GetCurrentSceneProcessId: GetCurrentSceneProcessId_callback? = null

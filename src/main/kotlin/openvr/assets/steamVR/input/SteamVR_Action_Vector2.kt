...
typealias SteamVR_Action_Vector2_AxisHandler = (fromAction: SteamVR_Action_Vector2, fromSource: SteamVR_Input_Sources, axis: Vec2, delta: Vec2) -> Unit
typealias SteamVR_Action_Vector2_ActiveChangeHandler = (fromAction: SteamVR_Action_Vector2, fromSource: SteamVR_Input_Sources, active: Boolean) -> Unit
typealias SteamVR_Action_Vector2_ChangeHandler = (fromAction: SteamVR_Action_Vector2, fromSource: SteamVR_Input_Sources, axis: Vec2, delta: Vec2) -> Unit
typealias SteamVR_Action_Vector2_UpdateHandler = (fromAction: SteamVR_Action_Vector2, fromSource: SteamVR_Input_Sources, axis: Vec2, delta: Vec2) -> Unit

/** An analog action with two values generally from -1 to 1. Also provides a delta since the last update. */
class SteamVR_Action_Vector2 : SteamVR_Action_In<SteamVR_Action_Vector2_Source_Map, SteamVR_Action_Vector2_Source>(),
        ISteamVR_Action_Vector2/*, ISerializationCallbackReceiver*/ {
...
//    { add { sourceMap[SteamVR_Input_Sources.Any].onActiveBindingChange += value; } remove { sourceMap[SteamVR_Input_Sources.Any].onActiveBindingChange -= value; } }
     ...
     *  Note: Will only return non-zero if the action is also active. */
    override val lastDelta: Vec2
        get() = sourceMap!![SteamVR_Input_Sources.Any]!!.lastDelta

//    override var sourceMap: SteamVR_Action_Vector2_Source_Map
//        get() = super.sourceMap
//        set(value) {}
     ...
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun addOnActiveChangeListener(functionToCall: SteamVR_Action_Vector2_ActiveChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun removeOnActiveChangeListener(functionToStopCalling: SteamVR_Action_Vector2_ActiveChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param functionToCall: A local function that receives the boolean action who's active state changes and the corresponding input source
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun addOnActiveBindingChangeListener(functionToCall: SteamVR_Action_Vector2_ActiveChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param functionToStopCalling: The local function that you've setup to receive update events
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun removeOnActiveBindingChangeListener(functionToStopCalling: SteamVR_Action_Vector2_ActiveChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun addOnChangeListener(functionToCall: SteamVR_Action_Vector2_ChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun removeOnChangeListener(functionToStopCalling: SteamVR_Action_Vector2_ChangeHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param functionToCall: A local function that receives the boolean action who's state has changed, the corresponding input source, and the new value
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun addOnUpdateListener(functionToCall: SteamVR_Action_Vector2_UpdateHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param functionToStopCalling: The local function that you've setup to receive update events
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun removeOnUpdateListener(functionToStopCalling: SteamVR_Action_Vector2_UpdateHandler, inputSource: SteamVR_Input_Sources) {
     ...
     *  @param functionToCall: A local function that receives the boolean action who's state has changed, the corresponding input source, and the new value
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun addOnAxisListener(functionToCall: SteamVR_Action_Vector2_AxisHandler, inputSource:  SteamVR_Input_Sources)    {
     ...
     *  @param functionToStopCalling: The local function that you've setup to receive update events
     *  @param inputSource: The device you would like to get data from. Any if the action is not device specific. */
    fun removeOnAxisListener( functionToStopCalling: SteamVR_Action_Vector2_AxisHandler, inputSource:  SteamVR_Input_Sources)    {
...
class SteamVR_Action_Vector2_Source_Map : SteamVR_Action_In_Source_Map<SteamVR_Action_Vector2_Source>()

class SteamVR_Action_Vector2_Source : SteamVR_Action_In_Source(), ISteamVR_Action_Vector2 {
    ...
    val onAxis = ArrayList<SteamVR_Action_Vector2_AxisHandler>()

    /** Event fires when the active state (ActionSet active and binding active) changes */
    val onActiveChange = ArrayList<SteamVR_Action_Vector2_ActiveChangeHandler>()

    /** Event fires when the active state of the binding changes */
    val onActiveBindingChange = ArrayList<SteamVR_Action_Vector2_ActiveChangeHandler>()

    /** This event fires whenever the axis changes by more than the specified changeTolerance */
    val onChange = ArrayList<SteamVR_Action_Vector2_ChangeHandler>()

    /** Event fires when the action is updated */
    val onUpdate = ArrayList<SteamVR_Action_Vector2_UpdateHandler>()


    /** The current Vector2 value of the action.
     *  Note: Will only return non-zero if the action is also active. */
    override var axis = Vec2()
        protected set

    /** The Vector2 value of the action from the previous update.
     *  Note: Will only return non-zero if the action is also active. */
    override var lastAxis = Vec2()
        protected set

    /** The Vector2 value difference between this update and the previous update.
     *  Note: Will only return non-zero if the action is also active. */
    override var delta = Vec2()
        protected set

    /** The Vector2 value difference between the previous update and update before that.
     *  Note: Will only return non-zero if the action is also active. */
    override var lastDelta = Vec2()
        protected set
    ...
    protected lateinit var vector2Action: SteamVR_Action_Vector2
    ...
    override fun preinitialize(wrappingAction: SteamVR_Action, forInputSource: SteamVR_Input_Sources) {
        ...
        vector2Action = wrappingAction as SteamVR_Action_Vector2
    }
    ...
    override fun updateValue() {
        ...
        axis = Vec2(actionData.x, actionData.y)
        delta = Vec2(actionData.deltaX, actionData.deltaY)
        ...
        if (lastActiveBinding != activeBinding)
            onActiveBindingChange.forEach { it(vector2Action, inputSource, activeBinding) }

        if (lastActive != active)
            onActiveChange.forEach { it(vector2Action, inputSource, activeBinding) }
    }
}

interface ISteamVR_Action_Vector2 : ISteamVR_Action_In_Source {

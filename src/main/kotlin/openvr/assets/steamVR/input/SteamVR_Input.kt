...
import openvr.assets.steamVR.script.SteamVR_Behaviour
import openvr.assets.steamVR.script.SteamVR_Settings
import openvr.assets.steamVR.script.SteamVR_Utils
        ...
        if (caseSensitive)
            ...
            if (path in actionSetsByPathCache) {
                ...
                if (loweredPath in actionSetsByPathLowered) {
                    ...
                    return actionSetsByPathLowered[loweredPath]!!.getCopy()
                } else

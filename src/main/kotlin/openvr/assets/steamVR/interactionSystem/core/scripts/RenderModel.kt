package openvr.assets.steamVR.interactionSystem.core.scripts

import openvr.plugin2.Material
import openvr.plugin2.SteamVR_Input_Sources
import openvr.plugin2.SteamVR_RenderModel
import openvr.plugin2.Transform
import openvr.assets.steamVR.input.SteamVR_Behaviour_Skeleton
import openvr.assets.steamVR.script.SteamVR_Events
...
//    protected GameObject handInstance;
    protected lateinit var handTransform: Transform
    //    protected Renderer[] handRenderers;
    var displayHandByDefault = true
    protected var handSkeleton: SteamVR_Behaviour_Skeleton? = null
//    protected Animator handAnimator

    protected val animatorParameterStateName = "AnimationState"
    protected var handAnimatorStateId = -1


    //    public GameObject controllerPrefab
//    protected GameObject controllerInstance
//    protected Renderer[] controllerRenderers
    protected lateinit var controllerRenderModel: SteamVR_RenderModel
    var displayControllerByDefault = true
    protected lateinit var delayedSetMaterial: Material

    var onControllerLoaded: (() -> Unit)? = null

    protected lateinit var renderModelLoadedAction: SteamVR_Events.Action

    protected lateinit var inputSource: SteamVR_Input_Sources
...
//        InitializeController()
    ...
    protected fun initializeHand() {
//        if (handPrefab != null) {
        handTransform = Transform().apply {
...
//    }
//
    private fun onRenderModelLoaded(loadedRenderModel: SteamVR_RenderModel, success: Boolean) {
